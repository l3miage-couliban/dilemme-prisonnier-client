    ...
    return (
        <div class="flex flex-col items-center bg-sky-900 h-screen text-white pt-6">
            <div class="title text-orange-400">
                ...
                {gameDetails.value.statut === "TERMINE" && !areScoresEquals.value && <div class="game-ended text-center w-fit">VAINQUEUR : {winnerName.value} </div>}
                {gameDetails.value.statut === "TERMINE" && areScoresEquals.value && <div class="game-ended text-center w-fit"> MATCH NUL </div>}
            </div>
            ...
            <div class="flex flex-row w-full justify-around items-center mt-16">
                ...
                <div class="flex flex-row items-center">
                    ...
                    <div class="vs text-yellow-400 mx-24">VS</div>
